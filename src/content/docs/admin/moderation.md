...
- **Mass-delete detection** — a publish that shrinks a page below a configurable ratio of its former size is flagged instead of silently going out; vandalism over a shared edit link does not become the published version unreviewed.
