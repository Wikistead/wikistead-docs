...
- **[What each plan includes](/reference/plan-contents/)** — every feature a plan can turn on or off: what it controls, where it is enforced, what happens on a downgrade, and what a self-hosted Community deployment gets.
